...
class Model_master extends CI_Model{
    ...
    function list_data_luas_lahan($kecamatan,$komoditas,$tahun,$limit,$offset)
    {
        $this->db->select('
        a.id,
        a.tahun,
        ...
        c.komoditas,
        b.nama_kecamatan');
        $this->db->from('luas_lahan as a');
        $this->db->join('master_wilayah AS b', 'a.kecamatan = b.no_kec', 'INNER');
        $this->db->join('komoditas AS c','a.komoditas = c.id','INNER');
        if($kecamatan) {
            $this->db->where('a.kecamatan', $kecamatan);
        }
    ...
    function list_total_luas_lahan($kecamatan,$komoditas,$tahun)
    {
        $this->db->select('*');
        $this->db->from('luas_lahan as a');
        $this->db->join('master_wilayah AS b', 'a.kecamatan = b.no_kec', 'INNER');
