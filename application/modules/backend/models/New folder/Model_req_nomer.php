...
class Model_req_nomer extends CI_Model{
    ...
    {
        $this->db->select('a.id, a.request_id, a.nip, a.nama_lgkp, a.kd_unor, a.telp, a.no_lama, a.no_baru, a.berkas, a.referensi, a.`status`, a.created, a.created_by, a.modified, a.modified_by, b.NM_UNOR');
