	...
	<div class="col-md-12">
		<form id="form_users" class="form-horizontal">
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<?php echo form_label('Permission Key', 'perm_key', array('class' => 'col-md-12 control-label-left')); ?>
						<div class="col-md-8">
				...
				<div class="col-md-6">
					<div class="form-group">
						<?php echo form_label('Permission Name', 'perm_name', array('class' => 'col-md-12 control-label-left')); ?>
						<div class="col-md-8">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<?php echo form_label('Groups', 'groups', array('class' => 'col-md-12 control-label-left')); ?>
						<div class="col-md-8">
							<div class="row">
								<div class="col-md-12">
...
<script>
	function simpan(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>backend/group_permissions/simpan",
