		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<?php echo form_label('Minggu ke', 'komoditas', array('class' => 'col-md-12 control-label-left')); ?>
							<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-12">
								<?php echo form_dropdown('komoditas', $filter_komoditas,"", 'id="komoditas_filter", class="form-control select2"'); ?>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							<table id="main-table" class="table table-bordered table-hover table-condensed mb-4">
								...
								<tbody>
								<tr>
									<td class="text-center" style="font-weight: bold"><?php echo form_input(['name' => 'produksi', 'id' => 'produksi', 'class' => 'form-control input-sm', 'placeholder' => '']); ?></td>
									<td class="text-center" style="font-weight: bold"><?php echo form_input(['name' => 'ketersediaan', 'id' => 'ketersediaan', 'class' => 'form-control input-sm', 'placeholder' => '']); ?></td>
									<td class="text-center" style="font-weight: bold"><?php echo form_input(['name' => 'kebutuhan', 'id' => 'kebutuhan', 'class' => 'form-control input-sm', 'placeholder' => '']); ?></td>
									<td class="text-center" style="font-weight: bold"><?php echo form_input(['name' => 'neraca', 'id' => 'neraca', 'class' => 'form-control input-sm', 'placeholder' => '']); ?></td>
									<td class="text-center" style="font-weight: bold"><?php echo form_input(['name' => 'harga_konsumen', 'id' => 'harga_konsumen', 'class' => 'form-control input-sm', 'placeholder' => '']); ?></td>
								</tr>
								</tbody>
							</table>
						</div>
