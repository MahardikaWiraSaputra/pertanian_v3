		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">MONITORING LOG</h3>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo form_dropdown('response', array('all'=>'Semua','berhasil'=>'Berhasil', 'gagal'=>'Tidak Berhasil'), 'all', 'id="response" class="form-control select2" onchange="get_items()"')?>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-3">
									...
									<div class="col-sm-9">
										<div class="input-group input-group-sm">
											...
											<div class="input-group-btn">
												<a class="btn btn-info btn-flat" onchange="get_items()" onclick="get_items()">CARI</a>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function get_satker(){
		...
		load('backend/logs/get_satker/'+id, '#filter_satker');
	}
