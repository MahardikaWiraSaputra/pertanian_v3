...
<script>
                ...
                { "width": "10%", 
                    "render": function ( data, type, row ) { 
                        if (row.cert_pem == 'ada' && row.cert_p12 == 'ada') {
                            var html  = '<a id="data_detail" href="#" data-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_pem.png" class="rounded-circle m-r-5" alt=""></a><a id="verify_p12" href="#" daunta-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_p12.png" class="roded-circle m-r-5" alt=""></a>'
                        } 
                        else if (row.cert_pem == 'ada' && row.cert_p12 == 'tidak'){
                            var html  = '<a id="data_detail" href="#" data-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_pem.png" class="rounded-circle m-r-5" alt=""></a> <a id="upload_p12" href="#" data-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_no_p12.png" class="rounded-circle m-r-5" alt=""></a>'
                        }
                        else if (row.cert_pem == 'tidak' && row.cert_p12 == 'ada'){
                            var html  = '<a id="data_detail" href="#" data-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_no_pem.png" class="rounded-circle m-r-5" alt=""></a> <a id="verify_p12" href="#" data-id='+row.nip+'><img width="28" height="28" src="<?php echo base_url();?>assets/default/img/icon_p12.png" class="rounded-circle m-r-5" alt=""></a>'
                        }
                        else {
   ...
   $(document).on("click", "#data_tambah", function() {
    ...
    $('#datatable').on('click','#upload_p12',function(){
        ...
        $('#modal_upload_p12').on('click','#btn_upload_p12',function(e){
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url  : "<?php echo base_url()?>administrator/pengguna/upload_cert",
                data: formData,
                contentType: false,
                processData: false,
                dataType: "JSON",
        ...
        $('#modal_upload_p12').on('hidden.bs.modal', function(e){
           $(this).find('#form_upload_p12')[0].reset();           
        });
