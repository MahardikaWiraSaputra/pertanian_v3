<div class="content">
    <div class="row">
        <div class="col-sm-4 col-3">
            <h4 class="page-title">Api Key</h4></div>
        <div class="col-sm-8 col-9 text-right m-b-20"> <a href="#" class="btn btn btn-primary btn-rounded float-right" id="data_tambah"><i class="fa fa-plus"></i> Tambah Api Key</a></div>
    </div>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="profile-upload">
                                    ...
                                    <div class="upload-input">
                                        <input type="file" class="form-control" name="file-cert" id="file-cert">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="profile-upload">
                                    ...
                                    <div class="upload-input">
                                        <input type="file" class="form-control" name="file-key" id="file-key">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        tabel = $('#datatable').DataTable({
            ...
            "ajax":
                {
                    "url": "<?php echo base_url()?>administrator/api/get_data",
                    "type": "POST"
                },
            "deferRender": true,
            ...
            "columns": [
                ...
                { "width": "20%","render": function ( data, type, row ) { 
                        var html = ""
                        var html  = '<img width="28" height="28" src="<?php echo base_url();?>uploads/img_api/default.png" class="rounded-circle m-r-5" alt="">'
                        html += row.user_id
                        return html
                    }
                },
                { "data": "api_key" },
                { "data": "url_domain" },
                { "width": "10%", "render": function ( data, type, row ) { 
                        var html = ""
                        if (row.api_key_activated == 'yes') {
                        var html  = '<span class="custom-badge status-green">'
                        }
                        else {
                          var html  = '<span class="custom-badge status-red">'  
                        }
                        html += row.api_key_activated
                        html += '</span>'
                        return html
                    }
                },
