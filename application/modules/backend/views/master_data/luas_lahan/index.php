...
<div class="page-title-box">
	<div class="row align-items-center">
		<div class="col-sm-6">
			<h4 class="page-title">Luas Lahan Pertanian</h4>
		</div>
		<div class="col-sm-6">
...
<script type="text/javascript">
	...
	function get_items(page){
	    ...
	    $.post(site+'backend/master_data/list_data_lahan_pertanian', {
			bulan: $('#bulan').val(),
	...
	function tambah(){
		...
		$('.modal-title').html(title);
  		ajax_modal('backend/master_data/tambah_lahan_pertanian');
	}
</script>