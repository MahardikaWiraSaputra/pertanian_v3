      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <button type="button" class="btn btn-info btn-xs btn-info" onclick="edit('<?php echo $row->kategori; ?>','<?=$row->tahun;?>')">Edit</button>
                <button type="button" class="btn btn-info btn-xs btn-danger" onclick="hapus('<?php echo $row->kategori; ?>','<?=$row->tahun;?>')">Del</button>
              </div>
            </td>
          </tr>
          <?php endforeach;?>
