...
class Master_data extends CI_Controller {
    ...
    public function index_lahan_pertanian()
    {
        $data['filter_kecamatan'] = $this->model_pertanian->kecamatan($this->ion_auth->user()->row()->kecamatan);
        $data['filter_komoditas'] = $this->model_pertanian->komoditas();
        $data['filter_tahun'] = $this->model_pertanian->tahun();
        $data['filter_bulan'] = $this->model_pertanian->bulan();
        $this->load->view('master_data/luas_lahan/index', $data);
    }

    public function list_data_lahan_pertanian(){
        $page = '1';
        $offset = '0';
        $limit = 25;
        $like = array();
        ...
        $data['total_items'] = $this->model_master->list_total_luas_lahan($kecamatan,$komoditas,$tahun)->num_rows();
        $data['list_items'] = $this->model_master->list_data_luas_lahan($kecamatan,$komoditas,$tahun,$limit,$offset)->result();
        
        $this->load->view('master_data/luas_lahan/v_list', $data );
    }

    public function laporan(){
        $data['filter_kecamatan'] = $this->model_pertanian->kecamatan();
        $data['filter_komoditas'] = $this->model_pertanian->komoditas();
        $data['filter_tahun'] = $this->model_pertanian->tahun();
        $data['filter_bulan'] = $this->model_pertanian->bulan();
    ...
    // tambah
    public function tambah_lahan_pertanian(){
        ...
        $this->load->view('master_data/luas_lahan/v_tambah', $data);
    }
    ...
    public function simpan_luas_lahan() {

        $this->load->library('form_validation');
        $this->form_validation->set_rules('kecamatan', 'kecamatan', 'trim|required');
        $this->form_validation->set_rules('komoditas', 'komoditas', 'trim|required');
        $this->form_validation->set_rules('tahun', 'tahun', 'trim|required');
        $this->form_validation->set_rules('luas_lahan', 'luas_lahan', 'trim|required');
        if($this->form_validation->run()) {
            ...
            $query = $this->db->insert('luas_lahan',$data);
            if ($query) {
                    $output['success'] = true;
