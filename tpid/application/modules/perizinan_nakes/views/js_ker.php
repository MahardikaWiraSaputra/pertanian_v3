        ...
        $(document).ready(function() {
            ...
            function onEachFeature(feature, layer) {
                ...
                var marker = L.marker([lat, lon], {
                    ...
                    $.get(url + 'perizinan_nakes/modal_nakes_all/?kecamatan=' + kecamatan, {}, function(data) {
                        $("#modal_title").html('Detail Perizinan Tenaga Kesehatan Kecamatan ' + kecamatan)
                        const dataSource = {
                        chart: {
        ...
        <script type="text/javascript">
            function modal_by_kec(kecamatan) {
                ...
                var url = '<?=site_url();?>'
                $.ajax({
                    url: "perizinan_nakes/modal_nakes_all",
                    type: "GET",
