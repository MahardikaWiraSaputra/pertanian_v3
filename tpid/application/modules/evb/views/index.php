                  ...
                  <div class="col-span-12 sm:col-span-6 xl:col-span-7 intro-y">
                    <div class="report-box zoom-in">
                      <div class="box p-5">
                        ...
                        <div class="text-3xl font-bold leading-8 mt-6">Rp. 324,055,620,000 Anggaran Tahun 2019</div>
                        <div class="text-base text-gray-600 mt-1">Untuk Seluruh Desa Kabupaten Banyuwangi</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6 xl:col-span-5 intro-y">
                    <div class="report-box zoom-in">
                      <div class="box p-5">
                        ...
                        <div class="text-2xl font-bold leading-8 mt-6">Anggaran pengembangan 189 Desa</div>
                        <div class="text-base text-gray-600 mt-1">Kabupaten Banyuwangi</div>
                      </div>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="intro-y box">
                                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                            <h2 class="font-medium text-base mr-auto">
                                              Desa dengan Alokasi Dana Desa Terbesar-Terkecil
                                            </h2>
                                    ...
                                    <div class="intro-y box">
                                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                            <h2 class="font-medium text-base mr-auto">
                                                ...
                                                Kecamatan dengan Alokasi Dana Desa Terbesar-Terkecil
                                            </h2>
                                        </div>
                                ...
                                <div class="col-span-12 lg:col-span-12">
                                    ...
                                    <div class="intro-y box mt-5">
                                      <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                          <h2 class="font-medium text-base mr-auto">
                                              E-Village Budgeting Berdasarkan Kecamatan
                                          </h2>
