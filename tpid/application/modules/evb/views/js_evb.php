        ...
        $(document).ready(function() {
            ...
            function onEachFeature(feature, layer) {
                ...
                var marker = L.marker([lat, lon], {
                    ...
                    $.get(url + 'evb/modal_evb_kecamatan/?kecamatan=' + kecamatan, {}, function(data) {
                        $("#modal_title_detail").html('Detail Alokasi Dana Semua Desa Kecamatan ' + kecamatan)
                        const dataSource = {
                        chart: {
                            height: "100px",
                            baseFontSize: "13",
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    const dataSource = {
                        chart: {
                            caption: "Sumber : E-Village Budgeting",
                            // subcaption: "2019",
                            plottooltext: "$dataValue",
                            yaxisname: "Alokasi Dana",
                        ...
                        categories: [
                            {
                            category: data.top_pendapatan_desa[0]
                            }
                        ],
                        dataset: [
                            {
                            data: data.top_pendapatan_desa[1]
                            }
                        ]
                        };
                        ...
                        categories: [
                            {
                            category: data.top_pendapatan_by_kecamatan[0]
                            }
                        ],
                        dataset: [
                            {
                            data: data.top_pendapatan_by_kecamatan[1]
                            }
                        ]
                        };
        ...
        <script type="text/javascript">
            function modal_by_desa(desa,dana) {
                var desa,dana;
                dana = dana;
                desa = desa;
                var url = '<?=site_url();?>'
                $.ajax({
                    ...
                    dataType: "JSON",
                    beforeSend: () => {
                        $("#modal_title").html('Detail Penyerapan Alokasi Dana Desa  ' + desa)
                        $("#info").html(`<span style='font-size:2rem; color:##0335fc;'><strong>Sedang memperbaharui data..</strong></span>`)
                    },
                    success: (data) => {
                        $("#info").html("")
                        ...
                        const dataSources = {
                            chart: {
                                caption: "Penyerapan Alokasi dana berdasarkan Program Desa",
                                plottooltext: "<b>$percentValue</b> Tenaga Kesehatan di $label",
                                showlegend: "1",
                                showpercentvalues: "1",
                                legendposition: "bottom",
                            ...
                            $('#alokasi').html(numeral(dana).format('0,0'));
                            $('#penyerapan').html(numeral(dana).format('0,0'));
