...
class Sosial_model extends CI_Model
{
    ...
    function bpnt_all_kecamatan()
    {
        $this->db->select('SUM(jumlah_kpm) as value,kecamatan as label');
    ...
    function pkh_all_kecamatan()
    {
        $this->db->select('SUM(jumlah_pkh) as value,kecamatan as label');
        $this->db->from('bc_dinsos');
        $this->db->group_by('kecamatan');
        $this->db->order_by('value','DESC');
        return $this->db->get()->result_array();
    ...
    function bpnt_filter_kecamatan($kecamatan)
    {
        $this->db->select('SUM(jumlah_kpm) as value,desa as label');
        $this->db->from('bc_dinsos');
    ...
    function pkh_filter_kecamatan($kecamatan)
    {
        $this->db->select('SUM(jumlah_pkh) as value,desa as label');
        $this->db->from('bc_dinsos');
        $this->db->where('kecamatan',$kecamatan);
        $this->db->group_by('desa');
        $this->db->order_by('value','DESC');
    ...
    function sosial_all_kecamatan()
    {
        $this->db->select('SUM(jumlah_pkh) as pkh,SUM(jumlah_kpm) as bpnt,kecamatan');
        $this->db->from('bc_dinsos');
        $this->db->group_by('kecamatan');
        $this->db->order_by('pkh','DESC');
        return $this->db->get()->result();
    }
