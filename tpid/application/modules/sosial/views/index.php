...
<div class="content">
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    Informasi Penerima Program Keluarga Harapan dan Bantuan Pangan Non Tunai
                    </h2>
                </div>
                  ...
                  <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                    <div class="report-box zoom-in">
                      <div class="box p-5">
                        ...
                        <div class="text-3xl font-bold leading-8 mt-6">105.139 Penerima BPNT</div>
                        <div class="text-base text-gray-600 mt-1">Seluruh Kecamatan Banyuwangi</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                    <div class="report-box zoom-in">
                      <div class="box p-5">
                        ...
                        <div class="text-2xl font-bold leading-8 mt-6">82.913 Penerima PKH</div>
                        <div class="text-base text-gray-600 mt-1">Seluruh Kecamatan Banyuwangi</div>
                      </div>
                    </div>
                  </div>
                              ...
                              <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="intro-y box">
                                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                            <h2 class="font-medium text-base mr-auto">
                                              Jumlah Penerima Bantuan Pangan Non Tunai (BPNT)
                                            </h2>
                                ...
                                <div class="col-span-12 lg:col-span-12">
                                    ...
                                    <div class="intro-y box mt-5">
                                      <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                          <h2 class="font-medium text-base mr-auto">
                                              Penerima Data Bantuan Sosial Berdasarkan Kecamatan
                                          </h2>
                              ...
                              <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                                <div class="col-span-12 lg:col-span-12">
                                    ...
                                    <div class="intro-y box">
                                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                            <h2 class="font-medium text-base mr-auto">
                                                Tabel Total Penerima PKH dan BPNT berdasarkan Kecamatan
                                            </h2>
                                            ...
                                            <table id="tabel_data" class="table table-report table-report--bordered display datatable w-full">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-b-2 text-center whitespace-no-wrap">Penerima PKH</th>
                                                        <th class="border-b-2 text-center whitespace-no-wrap">Penerima BPNT</th>
                                                        <th class="border-b-2 text-center whitespace-no-wrap">Detail</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php foreach($by_kecamatan as $data):?>
                                                    <tr>
                                                        <td class="border-b">
                                                            <div class="font-medium whitespace-no-wrap"><?=$data->kecamatan?></div>
                                                        </td>
                                                        <td class="text-center border-b"><?=format($data->pkh)?></td>
                                                        <td class="text-center border-b"><?=format($data->bpnt)?></td>
                                                        <td class="border-b w-5">
                                                            <div class="flex sm:justify-center items-center">
                                                                <a onclick="modal_by_kec('<?=$data->kecamatan?>')" href="javascript:;" data-toggle="modal" data-target="#header-footer-modal-preview-new" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white"><i data-feather="activity" class="w-4 h-4 mr-2"></i> Detail </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endforeach;?>
